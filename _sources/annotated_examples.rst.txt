...
source: `bar_plot_stacked.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/bar_plot_stacked.py>`_
...
source: `bigdata.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/bigdata.py>`_
...
source: `cmap_image_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/cmap_image_plot.py>`_
...
source: `cmap_image_select.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/cmap_image_select.py>`_
...
source: `cmap_scatter.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/cmap_scatter.py>`_
...
source: `countour_cmap_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/contour_cmap_plot.py>`_
...
source: `countour_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/contour_plot.py>`_
...
source: `cursor_tool_demo.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/cursor_tool_demo.py>`_
...
source: `data_cube.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/advanced/data_cube.py>`_
...
source: `data_labels.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/data_labels.py>`_
...
source: `data_stream.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/advanced/data_stream.py>`_
...
source: `data_view.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/data_view.py>`_
...
source: `edit_line.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/edit_line.py>`_
...
source: `grid_container.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/grid_container.py>`_
...
source: `grid_container_aspect_ratio.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/grid_container_aspect_ratio.py>`_
...
source: `image_from_file.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/image_from_file.py>`_
...
source: `image_inspector.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/image_inspector.py>`_
...
source: `image_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/image_plot.py>`_
...
source: `inset_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/inset_plot.py>`_
...
source: `line_drawing.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/line_drawing.py>`_
...
source: `line_plot1.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/line_plot1.py>`_
...
source: `line_plot_hold.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/line_plot_hold.py>`_
...
source: `log_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/log_plot.py>`_
...
source: `nans_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/nans_plot.py>`_
...
source: `polygon_move.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/polygon_move.py>`_
...
source: `polygon_plot_demo.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/polygon_plot_demo.py>`_
...
source: `range_selection_demo.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/range_selection_demo.py>`_
...
source: `regression.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/regression.py>`_
...
source: `scalar_image_function_inspector.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/advanced/scalar_image_function_inspector.py>`_
...
source: `scales_test.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/scales_test.py>`_
...
source: `scatter.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/scatter.py>`_
...
source: `scatter_inspector.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/scatter_inspector.py>`_
...
source: `scatter_select.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/scatter_select.py>`_
...
source: `scrollbar.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/scrollbar.py>`_
...
source: `simple_line.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/simple_line.py>`_
...
.. [COMMENT]::
    ...
    source: `simple_polar.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/simple_polar.py>`_
...
source: `tabbed_plots.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/tabbed_plots.py>`_
...
source: `tornado.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/tornado.py>`_
...
source: `two_plots.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/two_plots.py>`_
...
source: `vertical_plot.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/vertical_plot.py>`_
...
source: `zoomable_colorbar.py <https://github.com/enthought/chaco/tree/master/chaco/examples/demo/basic/zoomable_colorbar.py>`_
