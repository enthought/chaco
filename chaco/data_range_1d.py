...
from traits.api import Bool, Callable, CFloat, Enum, Float, Property, Union
...
class DataRange1D(BaseDataRange):
    ...
    low_setting = Property(Union(Enum("auto", "track"), CFloat))
    ...
    high_setting = Property(Union(Enum("auto", "track"), CFloat))
