...
default_view = View(
    VGroup(
        Group(title_group, label="Title", show_border=True),
        Group(axis_line_group, label="Axis Line", show_border=True),
        HGroup(
            Group(tick_lines_group, label="Tick Lines", show_border=True),
            Group(tick_labels_group, label="Labels", show_border=True),
            label="Ticks",
        ),
        layout="tabbed",
    ),
