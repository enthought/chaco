#!/usr/bin/env python
"""
Draws a colormapped image plot with discrete data
...
def _create_plot_component():
    ...
    img_plot = plot.img_plot(
        "imagedata", xbounds=(0, 10), ybounds=(0, 5), colormap=viridis
    )[0]
    ...
    zoom =SelectingZoomTool(component=img_plot, tool_mode="box", always_on=False)
