...
from traits.api import Button, CArray, Bool, Float, Range, HasTraits, Instance, Property
from traitsui.api import Item, View, Group, RangeEditor, HGroup, Handler, spring
